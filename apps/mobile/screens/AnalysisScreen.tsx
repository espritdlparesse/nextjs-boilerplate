  ...
  return (
    <View style={appStyles.screen}>
      ...
      >
        ...
        <Text style={[appStyles.metaText, { color: theme.accentMutedText }]}>здесь должен быть не сухой summary, а короткая прожарка вкуса с наблюдениями, паттернами и нормальными реками.</Text>
        <PillButton
