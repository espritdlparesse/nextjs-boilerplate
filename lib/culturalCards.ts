...
const NEWS_MARKERS = [
  /\b(в|за)\s+\d{4}\s+год/i,
  /в\s+(январе|феврале|марте|апреле|мае|июне|июле|августе|сентябре|октябре|ноябре|декабре)\s+\d{4}/i,
  /\b(выпустил|представил|анонсировал|получил премию|номинирован)/i,
  /\bрелиз\b/i,
];
