...
function buildProfessorPrompt(items: Array<any>) {
  ...
  const instructions = `
Напиши 2-3 коротких предложения о человеке по его списку контента. Каждое — про одну категорию (музыка, книги, фильмы). Если какой-то категории нет — пропусти.

Тон: дружеская прожарка. Не злобно, но метко. Как будто близкий друг смотрит на твой список и не может промолчать.

Правила:
- Ровно 2-3 предложения, не больше
- Каждое предложение — наблюдение + лёгкий укол
- Цепляйся за конкретные названия из списка
- Разговорный русский, без пафоса и философии
- Никаких эмодзи, никаких списков

Примеры тона (не копируй):
«Восемь книг про одиночество — значит всё хорошо. The National на репите — классика жанра. Фильмов нет, но диагноз и так понятен.»
«Spotify на 40 треков и всё грустное — это не плейлист, это признание. Книги умные, фильмы артхаусные. Ты не скучный, но с тобой надо быть готовым.»
`.trim();
