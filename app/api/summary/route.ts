...
Затем с новой строки напиши блок рекомендаций — ровно 3 штуки, по одной на каждую категорию которая есть в списке. Формат: просто название и автор/исполнитель, одной строкой через запятую. Перед блоком напиши «→» и больше ничего.

Пример формата (не копируй содержимое):
Музыка вся грустная. Книги умные, но их три за год. Фильмов нет — это не минимализм.

→ Grouper — Ruins, Сэмюэл Беккет «Моллой», реж. Клэр Дени «Белый материал»
